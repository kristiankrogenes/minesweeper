...
public class Game {
    ...
    // "Trykker" på en knapp og oppdaterer antall bomber rundt feltet eller hvis det
    ...
    // Åpner opp felter hvis det ikke er noen bomber rundt, kalles fra openSquare og
